<template>
  <div class="channelApprovalPro">
    ...
    <div class="channelApprovalPro_pages" v-if="pendingData.length>0">
      <Page ref='pagess1' :total="total" :current="current"  @on-change="changePage" @on-page-size-change="changeSize" show-total show-elevator show-sizer class="page" ></Page>
    </div>
  </div>
</template>
<style lang="less">
  ...
  export default{
        ...
        pendingColumns: [
          ...
          },
          {
            ...
            render(row, column, index){
              ...
              if (row.approveStatus == "01" || row.approveStatus == "02") {
    ...
    methods:{
      ...
      search(){
        if(!!this.alllist){
          this.$nextTick(()=>{
             this.$refs['pagess1']?this.$refs['pagess1'].current=1:""
          })
