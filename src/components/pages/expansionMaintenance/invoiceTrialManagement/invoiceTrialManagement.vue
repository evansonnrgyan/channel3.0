    ...
    <div ref="expension-mainterance" class="expension-mainterance vue-theader" style="overflow-y:auto">
        ...
        <div class="channels-common-body clearboth">
            <div class="channels-common-body-button font-right">
                <Button type="primary" size="large" @click="policyPostDefaultSet">发票审放默认政策</Button>
        ...
        <Modal
                ...
                :title="isBrantchEidt?'批量设置发票审放模式':'设置发票审放模式'">
            <Table border class="vue-theader" height="200" :columns="setColumns" :data="setData"></Table>
            <Form ref="formValidate" :model.trim="formValidate" :rules="ruleValidate" :label-width="120">
                <Row class="padding10">
                    <Col span="24">
                        <Row class="padding10">
                            <Col span="24">
                                <FormItem label="发票审放模式" prop="newCarOffset">
    ...
    export default {
                    ...
                    },
                    {
                        ...
                        render: (h, params) => {
                            return h('div', [
                                ...
                                }, !params.row.invoiceModel?"":params.row.invoiceModel === "1" ? "是" : "否")
                            ]);
                        }
                    },
                    {
        ...
        methods: {
            loadList() {
                ...
                this.tloading = true;
                this.$http.post('/expInvoicePolicyRelationController/queryExpInvoicePolicyRelationList', params).then(resp => {
            ...
            policyPostDefaultSet() {
                this.$http.post("/expInvoicePolicyRelationController/getDefault").then(resp => {
                    this.formValidate1.newCarOffset = resp.data.data.invoiceModel;
            ...
            batchEdit() {
                ...
                this.$http.post("/expInvoicePolicyRelationController/queryInvoicePolicyRelationListById", params).then((resp) => {
                    if (resp.data.success) {
                ...
                this.$http.post("/expInvoicePolicyRelationController/queryInvoicePolicyRelationListById", params).then((resp) => {
                    if (resp.data.success) {
                        if (resp.data.data.length > 0) {
                            ...
                            this.setData = resp.data.data;
                            this.formValidate.newCarOffset = resp.data.data[0].invoiceModel;
                            ...
                            this.$http.post("/log/queryLogByGroupCode", paramsData).then((resp) => {
                                ...
                                if (resp.data.success) {
                                    ...
                                    //this.$Message.error(resp.data.errorMessage || "日志请求失败");
                                }
                                this.setModal = true;
                            })
            ...
            setSubmit() {
                ...
                if (this.isBrantchEidt) {
                    ...
                    params = {
                        channelId: arr.join(','),
                        invoiceModel: this.formValidate.newCarOffset,
                ...
                this.$refs["formValidate"].validate((valid) => {
                    if (valid) {
                        ...
                        this.$http.post("/expInvoicePolicyRelationController/updateTbExpInvoicePolicy", params).then((resp) => {
            ...
            modalDefaultEvent() {
                let params = {
                    invoiceModel: this.formValidate1.newCarOffset
                };

                this.$refs["formValidate1"].validate((valid) => {
                    if (valid) {
                        this.$http.post("/expInvoicePolicyRelationController/setDefaultTbExpInvoicePolicy", params).then(resp => {
                            if (resp.data.success) {
