...
<script>
  ...
  export default {
    ...
    methods: {
            ...
            img.onload = function() {
              ...
              self.$ajax.post('zuul/channel/file/upload.do', formData, config).then(res => {
                ...
                if (res.data.success) {
                  ...
                  self.viewSrc_source = self.$viewURL_PATH + d.serverFileName;
      ...
      handleView () {
        if(!this.showFlag){
          window.open( this.viewSrc_source );
      ...
      returnImg(newVal){
        ...
        this.viewSrc_source = this.$viewURL_PATH + newVal.serverFileName;
      ...
      openBig(){
          ...
          img.onload = function() {
              ...
              var gallery = new PhotoSwipe( pswpElement, PhotoSwipeUI_Default, _this.imgList, options);
              gallery.init();
          }
