            ...
            <Row>
                <Col span="24">
                    <FormItem label="保证金缴纳凭证" prop="img">
                        <oneFile :value.sync="formValidate.img" attachmentCode="0000000033" :btns="edit? ['show','down','again'] : ['show','down']" @clearValidate="clearValidate"></oneFile>
                    </FormItem>
                </Col>
            </Row>
